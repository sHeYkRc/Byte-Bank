...
public class TestLambda {
	...
	public static void main(String[] args) {
		...
		System.out.println("Ordenamiento por nuemero con lambda");
		for (Cuenta c : lista) {
			System.out.println(c);
		}
		...
		lista.forEach((Cuenta c)-> System.out.println("imprecion con lambda haciendo uso de la interfaz Consumer: " + c)); 
	
		
		System.out.println("Ordenado con la clase collections, mediante lamda que acomoda por titular");
		for (Cuenta c : lista) {
			System.out.println(c);
		}
